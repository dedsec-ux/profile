...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center justify-center bg-muted/30 relative">
          ...
          <div className="animate-slide-in-left text-left">
            ...
            <div className="flex space-x-6">
              <a
                ...
                className="glass bg-primary/10 hover:bg-primary hover:text-primary-foreground text-primary p-3 rounded-lg transition-all duration-200 hover:shadow-lg"
              >
